...
function p(radius: number, angle: number): THREE.Vector2 {
...
function Assembly() {
  ...
  useFrame((state) => {
    ...
    group.current.rotation.x =
      0.18 +
      Math.sin(state.clock.elapsedTime * 0.4) * 0.012;

    group.current.rotation.y =
      0.14 +
      Math.cos(state.clock.elapsedTime * 0.45) * 0.012;
  });
